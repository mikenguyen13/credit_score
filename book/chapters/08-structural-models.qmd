...
$$ {#eq-altman-z}
where $X_1 = $ working capital / total assets, $X_2 = $ retained earnings / total assets, $X_3 = $ EBIT / total assets, $X_4 = $ market value of equity / book value of total liabilities, $X_5 = $ sales / total assets. Higher Z means safer. The classical thresholds are Z above 2.99 (safe), between 1.81 and 2.99 (grey), below 1.81 (distress).
