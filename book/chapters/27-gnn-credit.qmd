...
- Seeding the simulation from the highest-leverage nodes (as opposed to random firms) produces much larger cascades. The identity of the initial shock matters. DebtRank-like systemic-importance weights [@battiston2012debtrank] and their interbank analogues [@cont2013network; @upper2011simulation] formalize this.
