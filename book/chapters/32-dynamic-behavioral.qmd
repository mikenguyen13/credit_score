...
governs first-passage default. @eq-pdpit, @eq-kernel, and @eq-hazard carry the same statistical content when the state process is Markov and continuous. They diverge the moment we admit history dependence or unobserved heterogeneity.
...
- @lando2002analyzing for continuous-time rating transition estimation, the corporate analogue of retail HMMs.
