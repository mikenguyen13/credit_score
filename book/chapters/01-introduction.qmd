...
The second development was big-tech platform scoring. @bis2020data document that a Chinese fintech platform's machine-learning models trained on payment and commerce data from its parent platform can predict small-business default at least as well as, and sometimes better than, commercial-bank models that rely on collateral values and financial statements. @gambacorta2024data extends the analysis. @bazarbash2019fintech and @agarwalzhang2020review survey the fintech-lending literature from IMF and academic perspectives. @philippon2016fintech frames the welfare question: how much of the incumbent banking system's margin is due to genuine intermediation and how much is due to legacy cost that fintech can displace.
